...
class UniversityCourseListSearch extends UniversityCourseList
{
    ...
    {
        return [
            [['id', 'university_id', 'degree_id', 'major_id', 'intake', 'fees', 'duration', 'type', 'created_by', 'created_at', 'updated_by', 'updated_at'], 'integer'],
            [['name'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'id' => $this->id,
            'university_id' => Yii::$app->session['university_id'],

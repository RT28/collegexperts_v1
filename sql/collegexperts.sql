...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 11, 2016 at 11:36 AM
...
(1, 'Bachelors in Arts Anthrolopogy', 1, 1, 1, 1, 60, 80000, 3, 1, 1, '2016-09-11 09:32:03', 1, '2016-09-11 09:32:03');
...
CREATE TABLE IF NOT EXISTS `university_departments` (
  ...
  `university_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `student_intake` int(11) DEFAULT NULL,

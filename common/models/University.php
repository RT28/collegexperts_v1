...
class University extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['city_id', 'state_id', 'country_id', 'pincode', 'institution_type', 'establishment', 'no_of_students', 'no_of_internation_students', 'no_faculties', 'cost_of_living', 'hostel_strength', 'institution_ranking', 'avg_rating', 'status', 'created_by', 'updated_by', 'reviewed_by'], 'integer'],
            [['description', 'ranking_sources', 'video', 'virtual_tour', 'comments'], 'string'],
